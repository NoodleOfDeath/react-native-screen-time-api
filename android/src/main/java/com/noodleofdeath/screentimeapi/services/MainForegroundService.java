package com.noodleofdeath.screentimeapi.services;
...
import com.noodleofdeath.screentimeapi.activities.BlockedAppActivity;
import com.noodleofdeath.screentimeapi.activities.ChildSignedInActivity;
import com.noodleofdeath.screentimeapi.broadcasts.AppInstalledReceiver;
import com.noodleofdeath.screentimeapi.broadcasts.AppRemovedReceiver;
import com.noodleofdeath.screentimeapi.broadcasts.PhoneStateReceiver;
import com.noodleofdeath.screentimeapi.broadcasts.ScreenTimeReceiver;
import com.noodleofdeath.screentimeapi.broadcasts.SmsReceiver;
import com.noodleofdeath.screentimeapi.models.App;
import com.noodleofdeath.screentimeapi.models.Child;
import com.noodleofdeath.screentimeapi.models.Contact;
import com.noodleofdeath.screentimeapi.models.ScreenLock;
...
import static com.noodleofdeath.screentimeapi.NotificationChannelCreator.CHANNEL_ID;
...
public class MainForegroundService extends Service {
	...
	public static final String BLOCKED_APP_NAME_EXTRA = "com.noodleofdeath.screentimeapi.services.BLOCKED_APP_NAME_EXTRA";
	...
	private void setFence(DataSnapshot dataSnapshot) {
		final com.noodleofdeath.screentimeapi.models.Location childLocation = dataSnapshot.getValue(com.noodleofdeath.screentimeapi.models.Location.class);
	...
	private String getLollipopForegroundAppPackageName() {
		...
		try {
			...
			for (UsageStats stats : foregroundApps) {
                /*if (i == 0 && !"com.noodleofdeath.screentimeapi".equals(stats.getPackageName())) {
